...
const CookieBanner = ({ open, handleCookieClose, handleCookieAccepted, handleCookieDeclined }) => {
  return (
    <Modal open={open} onClose={handleCookieClose} disableScrollLock>
      <Box style={style}>
        <Box>
          <Typography variant='body2' sx={{ display: 'flex', justifyContent: 'center', margin: 0.5 }}>
